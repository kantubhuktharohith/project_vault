...
├── src/
│   ├── assets/            # Project thumbnail images & icons
│   ├── components/
│   │   ├── ui/            # Reusable UI primitives (Buttons, Modals, Inputs, etc.)
│   │   └── vault/         # Project Cards, Form Modals, and Footer components
│   ├── hooks/             # Custom React hooks (useProjects, useAdmin)
│   ├── lib/
│   │   ├── auth.server.ts # HMAC token verification & cookie sessions
│   │   ├── db.ts          # PostgreSQL database connection & table auto-initialization
│   │   └── projects.ts    # Project types, helpers, & default seed data
│   ├── routes/
│   │   ├── __root.tsx     # Root router layout & meta head tags
│   │   ├── index.tsx      # Main Vault dashboard view
│   │   └── auth.tsx       # Admin Login / Logout route
│   ├── router.tsx         # TanStack Router configuration
│   ├── server.ts         # Server entrypoint
│   └── styles.css         # Tailwind CSS & custom styling rules
...
Projects can be exported or imported via JSON files adhering to the following schema:
...
[
  {
    ...
    "description": "Interactive developer portfolio in terminal aesthetic.",
    "liveUrl": "https://example.com",
    "githubUrl": "https://github.com/user/repo",
    "imageUrl": "/assets/thumb.jpg",
